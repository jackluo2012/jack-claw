...
from jackclaw_team.api.schemas import TestRequest, TestResponse
from jackclaw_team.models import InboundMessage
...
# 定义应用程序的各个键值对，用于依赖注入系统
# 每个键值对包含一个名称和一个对应的类型或对象
# 运行器键，关联到object类型
_runner_key = web.AppKey("runner", object)
# 发送器键，关联到CaptureSender类
